...
{"keep": true|false,
 ...
 "apply": "КОНКРЕТНОЕ действие для нас, начни с глагола (Пересчитать/Подключить/Отключить/Проверить/Настроить…). Если пост хоть как-то касается наших ниш (гигиена рта, интим 18+, крио/бьюти, оптика, мамы-дети) — НАЗОВИ конкретный релевантный товар/категорию (дентал-салфетки, ирригаторы-ополаскиватель, крио-салфетки/гель, спреи 18+, оптика-спрей, детская паста), а не «наши товары» вообще. Только если пост чисто про механику МП без товарного угла (финансы/вывод/общая логистика) — можно без товара, но всё равно КОНКРЕТНОЕ действие, БЕЗ воды типа «учитывайте при планировании». НЕ выдумывай товары/форматы/наборы, которых нет в списке. 1 короткое предложение."}
