...
{"keep": true|false,
 ...
 "apply": "Достань из поста КОНКРЕТИКУ (техника/изменение/цифра/инструмент) и переведи в действие ДЛЯ НАС. НАЧИНАЙ СРАЗУ С ГЛАГОЛА. КОРОТКО: одна фраза, максимум две. НИКАКИХ ВВОДНЫХ И ПРЕАМБУЛ — ЗАПРЕЩЕНЫ обороты «Применимо ко всем нашим товарам», «Учитывайте при планировании», «Это касается всех наших товаров» и любое вступление; это вода, режь её, начинай с сути. Если совет универсален — просто дай действие, БЕЗ фразы «ко всем нашим товарам» (её не писать вообще). Про товар/нишу упоминай ТОЛЬКО там, где это реально обостряет шаг (категоризация → «особенно гигиена полости рта и бьюти»; правила 18+ → наши спреи 18+; детская ниша → детская паста; сезонность бьюти-процедур → крио). Если пост про ЧИСТУЮ механику МП (финансы, вывод, комиссии, тарифы, логистика, склады) — БЕЗ товаров, просто действие с цифрой. ЗАПРЕЩЕНО приплетать список «дентал-салфетки и ирригаторы» ради галочки.\nЭТАЛОНЫ СТИЛЯ (короткие, с глагола, без преамбулы) — повторяй такую подачу: 1) правила категорий WB → «проверить карточки в черновике и перепривязать категории под новые правила, особенно гигиену полости рта». 2) рост комиссии → «пересчитать юнит-экономику: комиссия категории 17,5%→24,5%». 3) фишка продвижения → «запустить автобиддер на дентал-склейке со ставкой ниже рынка, свернуть если ДРР выше 15%»."}
